...
const Signup = () => {
  ...
  return (
    <div className="py-10 bg-[#FAF2F2] ">
      <div className="flex h-[89vh] mx-64 font-poppins border-[1px] border-[#7D5A5A] rounded-[50px] bg-white ">
        <div className="w-1/2 flex flex-wrap justify-center py-5">
          <Card color="transparent" shadow={false}>
            ...
            <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
              ...
              <Button
                ...
                className="mt-6 text-[14px] bg-[#F1D1D1] text-[#503C3C] border-[#503C3C] border-[1px] font-poppins"
                fullWidth
              >
                sign up
              </Button>
        ...
        <div className="w-1/2 ">
          <img className="w-auto float-right h-full object-cover rounded-tr-[50px] rounded-br-[50px] " src={signup} alt="Signup" />
        </div>
      </div>
    </div>
  );
