  ...
  return (
    <div className="py-10 bg-[#FAF2F2] ">
      <div className="flex h-[89vh] mx-64 font-poppins border-[1px] border-[#7D5A5A] rounded-[50px] bg-white ">
        <div className="w-1/2 ">
          <img className="w-auto float-left h-full object-cover rounded-tl-[50px] rounded-bl-[50px] " src={login} alt="Login" />
        </div>
        <div className="w-1/2 flex flex-wrap justify-center py-5 my-16 -ml-10">
